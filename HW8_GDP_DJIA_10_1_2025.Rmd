...
GDP_DJIA  |> 
  ...
  labs(title = "Correlation between DJIA and GDP", x ="GDP", y ="DJIA")
```
...
ANSWER: The scatterplot shows a strong, positive correlation between DJIA and GDP, which is a fairly understandable relationship. High productivity in the stock market is indicative of a productive U.S. economy, and conversely, the stock market productivity is significantly lower when the U.S. economy is in a recession. Equally telling from the scatterplot is the fact that there aren't really any massive outliers. There are a few points between the 22500 & 25000 GDP range that lie slightly above the line of best fit, and a few additional points below that line. But aside from those, most points follow the best-fit line pretty closely.
