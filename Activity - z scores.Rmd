...
Based on the chart below, it's tough to find a clear pattern. Generally speaking there are ebs and flows between several month periods. For example, there are spikes in Oct. 2022 and Jan. 2023, but between that, the rate dips relatively low. I think this can be somewhat connected to "party holidays," like Haloween and New Years Eve, when the use of potentially dangerous drugs may be more common.  
...
**Write your answer here**
The chart below paints a more clear picture of the earlier half of the data set (for me at least). I felt like it was difficult to discern which values were actually relatively high, since they wer fairly bunched together. I think this demonstration helped me realize that unusually high spikes are more common that an initially thought. Generally speaking, unusully low call days became more common toward the later part of the data set, and by contrast, unusally high call days became less common -- a positive trend overall. 
...
**Write your answer here**
Tuesday, Oct. 4 saw 23 emergency calls related to drug overdoses, an abnormally high tally, seeing as the Tuesday avereage for that occurance was just over 10.  
...
**Write your answer here**
While I think the three low outliers listed in the above chart could make for more positive stories, the more newsworthy angle would be to explore the days with abnormally high call counts -- specifically the ones that don't fall on special days. For example, there's was a really large number of calls that took place on Jan. 1st, but odds are that can be chalked up to people using drugs with partying on New Year's Eve (and New Year's Day as well, I guess). I think the top three dates (Oct. 4, Jul. 14, and July 22) are specifically worth looking into though. There aren't any notably party-related holidays on any of those three days, and I think there's an investigative reporting opportunity in looking into those dates to find why there were so many 911 drug overdose related calls on seemingly ordinary days. 
