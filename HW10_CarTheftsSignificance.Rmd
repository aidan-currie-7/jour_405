...
Generally, I think there's a clear decrease in the monthly car theft rate across PG County. It's not completely linear, with some drops and spike here and there, but the monthly rate toward the end of the study is around (and in one case below) 300, when the rate stood at over 600 at the start of the study. Additionally, theft rates specifically seem to be lower in the winter/spring months.
...
We are 95% confident that the true mean falls between 415.1 and 505.7.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:**

I think the mean, in conjuction with the standard deviation, gives a fairly accurate depiction of the car thefts in a typical month. The data is extremely wide spread so there's inevitably outliers. But regardless, these two figures capture a good portion of the data, when taken into account together.  
...
HL: Car thefts have dipped. Is that trend permanent?
...
The p-value of 0.179, plus the clear difference between the two charts suggests that we can reject the null hypothesis -- there is a legitimate difference between the first and second half of the data period. I think this is especially evident through the fact that the upper side of the error bar for the second half, is below the mean of the second half. 
...
My initial headline was: "Car thefts have dipped. Is that trend permanent?" I think I'd change that to read: "Car thefts have dipped. Is the change sustainable?" I know some publications don't love using questions in their headlines, so I'm sure that may draw some questions from the editor, but I feel like it will draw readers in because it's forward-looking. I also feel like this type of headline/story would help address my editor's first anticipated questions: "Why have car thefts declined?" So the general trend will provide a basis for my story, but in order to write a compelling piece, I'd have to explain why it is happening.     
