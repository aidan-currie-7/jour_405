...
There's a clear distinction between private and public universities and their average SAT scores in comparison to that of community colleges. The mean and median for community colleges are both slightly over the 1000. The tallies for private and public colleges are around 300 - 375 points higher. 
...
ANSWER: Yes, SAT scores of community college students are significantly lower than that of both private and public schools. There's also a fair difference between public and private schools, at an average of 74 points, but the pails in comaprison to the three-figure difference between community colleges and four-year universities. Overall, the differences between each, reveal the general academic threshold of each type of institution.   

2. Which specific college types differ from each other?

ANSWER: Private and Public institutions clearly differ from community. The differences in mean value, lowest value, and highest value between private and public are clear, but relative to the other two categories, they're fairly small. As a result, private and public institutions hold more academic prestige than community colleges, in regard to test scores.    

3. How large are these differences?

ANSWER: The largest difference is between private and community colleges, with an average score differential of around 367. The differnce between public and community scores is similarly in the three figures, while the seperation between private and public is under 100. 
...
HL: Examining the SAT score gap between four-year and community colleges 

lead: Four-year universities are often considered more prestigious than community colleges. It's an assumption that some consider unfair, but test scores support that belief. 

Students attending private and public universities nationwide entered with average SAT scores of 1435 and 1361, respectively. That figure languished at 1068 for community college students -- a statistically significant difference, based on recent analysis.      
